...
Datos de salida: 1 cadena de texto que le indica a la persona si esta positivo para hemoglobina
Positivo --> str --> E
"""

# Entrada 
B = float(input("\nDigite tu edad en años "))
C = float(input("Digite tu nivel de hemoglobina en g% "))
if B > 15:
    D = float(input("Digite tu sexo, utiliza\n1 para masculino\n2 para femenino\n"))
else: 
    D = 0
# Caja negra 
